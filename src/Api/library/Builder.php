...
namespace itjack\apidoc\Api\library;


use itjack\apidoc\Api\widgets\ApiWidgets;
...
//    }
    ...
    {
        $docslist = $this->parse();
        $info=array_merge($vars, ['docslist' => $docslist]);
        return ApiWidgets::widget(['message' => $info]);
